...
(function($) {
	...
	$.alerts = {
		...
		_show: function(msg, value, ok, cancel, type, callback) {
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + ok + '" id="popup_ok" style="border: 1px solid black;;  padding: 4px 12px 3px 12px;margin: 0px 30px 0px -2px;background: rgb(61, 157, 179) none repeat scroll 0 0; box-shadow:none;	color:white"/></div>');
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + ok + '" id="popup_ok" style="  border: none;  padding: 4px 12px 3px 12px;margin: 0px 3px 0px -2px;background: #68128d; box-shadow:none;	color:white"/> <input type="button" value="' + cancel + '" id="popup_cancel" style="  border: none;  padding: 4px 12px 3px 12px;margin: 0px 30px 0px -2px;background: #68128d; box-shadow:none;	color:white""/></div>');
					 $("#popup_ok").click( function() {
						$.alerts._hide();
						if( callback ){
							callback(true);
